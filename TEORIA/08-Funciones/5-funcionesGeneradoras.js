...
function* generaID() {
    ...
    while(true) {
        ...
        yield id;
        // para que vaya enviando el número y se quede "parada" aquí

        /* yield = return, pero sin salir de la función "del todo", solo espera
        a que se le vuelva a llamar a la función */
    }
}
...
/* devuelve un objeto con propiedades "value" y "done" -> se puede obtener solo
el valor accediendo al dato como si fuera un objeto:
