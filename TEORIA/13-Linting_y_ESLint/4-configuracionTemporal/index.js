...
// APLICAR CONFIGURACIÓN EN TODOS NUESTROS PROYECTOS

/* 
1. ir al package.json
2. en la parte de los scripts escribimos -> "lint": "eslint ."
3. npm run lint -> nos dirá qué "errores" hay
    aparece también un mensaje de que los errores pueden arreglarse solos con:
    --fix
4. vamos a package.json y en el script escribimos debajo de la línea del paso 2
    "lint-fix": "eslint --fix"
5. npm run lint-fix -> corrige todos los errores menos el de console.log(), que
no lo elimina por si fuera necesario usarlo
