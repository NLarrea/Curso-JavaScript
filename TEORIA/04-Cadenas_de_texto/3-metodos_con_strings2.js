...
/* existe la opción de usar .toLocaleLowerCase() en vez de .toLowerCase(), pero
realmente son lo mismo, solo que hay idiomas (turco, por ejemplo) en los que
dan resultados diferentes. En este caso no nos es relevante */
...
/* esta no es una buena práctica, ya que si se cambia el tipo de alguna de las
variables str al tipo numérico (o las dos), podríamos estar sumando de forma
numérica en lugar de estar concatenando */
...
/*
.indexOf() -> devuelve la pos del primer char de esa palabra (la primera del
string que coincida). Si no hay coincidencias, devuelve -1
*/
console.log(str_palabra.indexOf("Naia"));           // 9
console.log(str_palabra.charAt(9));                 // N -> demostración
console.log(str_palabra.indexOf("Nahia"));          // -1 -> no lo encuentra

/* 
.lastIndexOf() -> devuelve la pos del primer char de la última palabra que
coincida con esa. Si no hay coincidencias, devuelve -1 también
*/
console.log(str_palabra.lastIndexOf("Naia"));       // 48
console.log(str_palabra.lastIndexOf("Nahia"));      // -1 -> no lo encuentra