...
/* esta última opción se está quedando obsoleta, por eso aparece tachada, y es
poco recomendable usarla */
...
console.log(cadena);
// Hola mi nombre es Naia
console.log(cadena.replace("Naia", "Cristina"));
...
console.log(texto_largo.replace("Tito", "Atom"));
// solo sustituye la primera coincidencia del nombre que encuentre
/*
"Atom no es un mono cualquiera. A Tito no le gusta trepar por los árboles y
odia comer plátanos. Él prefiere pasear por el bosque, oler las flores y
...
/*
"Atom no es un mono cualquiera. A Atom no le gusta trepar por los árboles y
odia comer plátanos. Él prefiere pasear por el bosque, oler las flores y
recoger las nueces que se caen de los árboles."
*/