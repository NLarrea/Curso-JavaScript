...
// DECLARACIÓN
let array = new Array(6); // forma 1 -> menos usada -> después abría que "rellenar" el array porque tiene 6 elementos vacíos
let array2 = [1,2,3,4,5,6]; // forma 2 -> más usada

// las listas pueden contener muchísimos tipos de datos
let var1 = 25;
let array_tipos = [1, "hola", false, {id:5}, null, undefined, var1];
// {id:5} es un objeto
console.log(array_tipos); // [ 1, 'hola', false, { id: 5 }, null, undefined, 25 ]
...
// tener en cuenta que .push() y .unshift() mutan el valor del array
// .push() aumenta los elementos entre paréntesis al final del array
array2.push("final");
console.log(array2); // [ 1, 2, 3, 4, 5, 6, 'final' ]

// .unshift() aumenta los elementos entre paréntesis al inicio del array
...
// si se le pone un 0 como segundo parámetro, es como no poner nada
...
array3.splice(2, 1, 3, 4, 5); // elimina el elemento en la pos 2, y añade los valores 3, 4 y 5
