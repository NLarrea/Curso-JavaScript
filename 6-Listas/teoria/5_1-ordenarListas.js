...
arr.sort((anterior, siguiente) => {
    return -1; // invierte el orden, porque anterior siempre tendrá un índice menor que siguiente
})
console.log(arr); // [ 4, 0, 2, 1, 15, 9, 5, 2 ]

arr.sort((anterior, siguiente) => {
    return 1; // devuelve el array tal y como estaba la última vez
})
console.log(arr); // [ 4, 0, 2, 1, 15, 9, 5, 2 ]
...
/* esta forma, "a-b", retorna la división entre a y b, si es "negativa", significa que
a es menor que b */
...
console.log(listaObjetos); // objetos ordenados por edades de menor a mayor
