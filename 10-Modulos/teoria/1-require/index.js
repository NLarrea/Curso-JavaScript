...
/* creamos la carpeta modulos, archivo matemáticas y copiamos las funciones en ese
archivo nuevo (en este, los comento para no quitarlos) */

/* si ahora ejecutamos este archivo, dará error porque no están definidas esas funciones.
Hay que importar las funciones del módulo matematicas */


// IMPORTACIÓN Y EXPORTACIÓN DE MÓDULOS
/*
FORMA 1: CommonJS -> require() -> por defecto (el que vamos a hacer en esta clase)
...
// comprobación de que funciona
const fact = factorial(5);
console.log(fact); // 120 -> ya no hay que escribir "moduloMatematicas.factorial(5)"
*/
