...
let b = 0.1; // "float"
console.log(b); // 0.1
/* en JS es independiente el tipo de número (int/float/...),
se declaran todos de la misma manera */
...
almacenar los datos en memoria. Este error también ocurre con las multiplicaciones
